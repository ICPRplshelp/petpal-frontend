...
function CommentCreateAppComponent({id}: CCACProps) {
    ...
    const handleSubmit = (e: FormEvent<never>) => {
        e.preventDefault();
        obj.target_application_id = id;
        const getCS2 = (): CS => {
            return {
                "content":
                    "",
                target_application_id: obj.target_application_id,
                rating: 0
            }
        }
...
export default CommentCreateAppComponent;